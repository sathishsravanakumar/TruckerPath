...
export const BACKHAUL_OPPORTUNITIES = [
  {
    ...
    stops: ["Phoenix, AZ", "Tucson, AZ", "El Paso, TX", "San Antonio, TX", "Dallas, TX"],
    next_stop_index: 1,
    status: "broadcast",
    winning_bid_id: null,
    award_reason: null,
    bids: [
      {
        ...
        bid_price: 1400,
        detour_cost: 112,
        cargo_volume_cuft: 1900,
        pickup_location: "Phoenix, AZ",
        pickup_address: "2150 W Buckeye Rd, Phoenix, AZ 85009",
        drop_address: "4200 S Palo Verde Rd, Tucson, AZ 85714",
        ...
        delivery_window: "Jul 14, 11:00 AM – 2:00 PM",
      ...
      },
      {
        ...
        pickup_location: "Mesa, AZ",
        pickup_address: "1625 W Main St, Mesa, AZ 85201",
        drop_address: "3600 E Irvington Rd, Tucson, AZ 85714",
        ...
        delivery_window: "Jul 14, 12:00 PM – 3:00 PM",
      ...
      },
      {
        ...
        pickup_location: "Phoenix, AZ",
        pickup_address: "3800 W Lower Buckeye Rd, Phoenix, AZ 85043",
      ...
      },
      {
        ...
        bid_price: 1600,
        detour_cost: 72,
        cargo_volume_cuft: 1400,
        pickup_location: "Chandler, AZ",
        pickup_address: "500 N 54th St, Chandler, AZ 85226",
      ...
      },
      {
        ...
        pickup_location: "Phoenix, AZ",
        pickup_address: "1200 N 48th St, Phoenix, AZ 85008",
        drop_address: "8500 Marbach Rd, San Antonio, TX 78227",
